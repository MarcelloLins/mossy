...
var Keys = KeyMap{
	...
	UpdateWorktree: key.NewBinding(
		key.WithKeys("u"),
		key.WithHelp("u", "update from default branch"),
	),
...
func (k KeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.AddRepo, k.DeleteRepo, k.NewWorktree, k.RemoveWorktree, k.UpdateWorktree},
